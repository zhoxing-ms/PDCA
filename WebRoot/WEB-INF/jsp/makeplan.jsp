...
.calendar dd {
	...
	height: 139px;
	font-weight: 700;
	background: url(style/images/o_bg.png) no-repeat;
	margin: 0;
}
...
.prevyear,.nextyear,.prevmonth,.nextmonth {
	cursor: pointer;
	height: 9px;
	background: url(style/images/o_nextprv.png) no-repeat;
	overflow: hidden;
	position: absolute;
	top: 8px;
	text-indent: -999px;
...
.input {
	...
	padding: 4px;
	background: url(style/images/o_nextprv.png) no-repeat right -18px;
}
</style>
...
var a = [];
function validate1() {
	var username = $("#selectname1").find("option:selected").val();
	//alert(username);
	if(username!="请选择"){
...
function validate() {
	...
	$.ajax({
		...
		success : function(data) {
			...
			var options = new Option(data[index].realname,data[index].realname);
			//options.style.color="red";
			$(options).appendTo("#selectname1");
			...
			<td>
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr class="currentpath">
						<td width="40px"><img
							src="<%=request.getContextPath()%>/styleNew/images/currentpath_1.gif">
						</td>
						<td>当前位置：录入计划</td>
						<td width="10px"><img
							src="<%=request.getContextPath()%>/styleNew/images/currentpath_2.gif">
						</td>
					</tr>
				</table> <s:form action="upload" method="post" enctype="multipart/form-data">
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
									...
									<tr align="center" class="tr_list_1">
										<td height="28" colspan="2" align="left">
											<table width="100%" border="0" cellpadding="0"
												cellspacing="3" class="table_show_input">
												<tr>
													<td width="130" height="28"><strong>目标执行人：</strong></td>
													<td width="1155">职务: <s:select name="selectName"
															list="#listRole" listKey="rolename" listValue="rolename"
															theme="simple" id="selectName" headerValue=""
															headerKey="请选择" onchange="return validate()">
														</s:select> &nbsp;&nbsp;部门: <s:select name="selectDeName" 
															list="#listDepartments" listKey="departName"
															listValue="departName" theme="simple" id="selectDeName"
															headerValue="" headerKey="请选择"
															onchange="return validate() ">
														</s:select> &nbsp;&nbsp;姓名:<select id="selectname1"
														name="selectname1" onchange="return validate1() ">
															<option>请选择</option>
													</select></td>
												</tr>
												...
												<tr>
													...
													<td><s:file name="fileUpload" theme="simple"
															id="fileUpload" onclick="changefile()" /></td>
												</tr>
												<tr>
													<td><strong>截止时间：</strong></td>
													<td>
														<!-- <input type="text" name="url.endtime" id="time"
						onfocus="c.showMoreDay = false;c.show(this);" /> --> <input
														size="25" name="url.endtime" type="text" id="j_Date1"
														class="input">
													</td>
												</tr>
											</table>
						...
						<tr>
							...
							<td align="right" class="td_page"><s:submit value="提交"
									cssClass="button" onclick="return Check();" theme="simple" />

								<input type="reset" name="Submit2" class="button" value="返 回"
